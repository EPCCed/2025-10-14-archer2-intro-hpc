...
This setup ensures you have an SSH client installed, ready to connect to a remote HPC system. 
...
For this lesson, we will be using [ARCHER2](archer2.ac.uk), the latest iteration of the UK National Supercomputing Service. ARCHER2 will be available to you for the duration of the course and for a few days afterwards, to allow you to complete the practical exercises and put some of what you have learned into practice.

Please register for an ARCHER2 account (you can also use an existing ARCHER2 account if you are already
a user).
